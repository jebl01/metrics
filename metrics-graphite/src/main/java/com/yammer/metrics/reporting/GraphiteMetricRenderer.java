...
public abstract class GraphiteMetricRenderer<MetricType extends Metric>
{
    ...
    public abstract void renderMetric(MetricType metric, GraphiteRendererContext context);
